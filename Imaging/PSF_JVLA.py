...
plt.title("ENU coordinate antenna - JVLA")
plt.scatter(ENU[:,0],
            ENU[:,1],
            c=ENU[:,2],
            marker="+",
...
uv_5min = track_simulator.sim_uv_v2(0.0, 90.0, 5/60, 60/3600, ENU, ARRAY_LATITUDE, True, False, CENTRE_CHANNEL)/CENTRE_CHANNEL/1e4

uv_6h_90_dec = track_simulator.sim_uv_v2(0.0, 90.0, 6, 60/3600, ENU, ARRAY_LATITUDE, True, False, CENTRE_CHANNEL)/CENTRE_CHANNEL/1e4
uv_6h_60_dec = track_simulator.sim_uv_v2(0.0, 60.0, 6, 60/3600, ENU, ARRAY_LATITUDE, True, False, CENTRE_CHANNEL)/CENTRE_CHANNEL/1e4
uv_6h_45_dec = track_simulator.sim_uv_v2(0.0, 45.0, 6, 60/3600, ENU, ARRAY_LATITUDE, True, False, CENTRE_CHANNEL)/CENTRE_CHANNEL/1e4
uv_6h_20_dec = track_simulator.sim_uv_v2(0.0, 20.0, 6, 60/3600, ENU, ARRAY_LATITUDE, True, False, CENTRE_CHANNEL)/CENTRE_CHANNEL/1e4
uv_6h_0_dec = track_simulator.sim_uv_v2(0.0, 0.0, 6, 60/3600, ENU, ARRAY_LATITUDE, True, False, CENTRE_CHANNEL)/CENTRE_CHANNEL/1e4
